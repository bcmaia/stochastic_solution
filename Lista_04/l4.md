...
Passageiros que chegam em um tempo t →E[Passageiros(t)]=tλ

E[Passageiros/Ônibus]=E[Passageiros(E[Ônibus])]=0.5⋅8=4
...
$$ V = 
    \left(
        \frac{\lambda_g}{\lambda_c+\lambda_g} \cdot \dfrac{1}{\lambda_c}
    \right) + \left(
        \dfrac{\lambda_c}{\lambda_c+\lambda_g} \cdot \dfrac{1}{\lambda_g}
    \right)
$$
